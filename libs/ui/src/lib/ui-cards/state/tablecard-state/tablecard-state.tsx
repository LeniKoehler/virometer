...
const URL_MID_TABLE = "/d-solo/aim5ADoGz/total-germany-counties-states?orgId=1&panelId=33"
...
interface TablecardStateProps {
  panelTheme?: string | "",
  panelHeight?: string
}

export const TablecardState = (props: TablecardStateProps) => {
  const { panelTheme, panelHeight } = props
  const title = `tableState`
