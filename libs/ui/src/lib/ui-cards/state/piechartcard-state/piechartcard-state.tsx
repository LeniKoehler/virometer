...
const URL_MID_TOTAL_GERMANY_INFECTIONS = "/d-solo/aim5ADoGz/total-germany-counties-states?orgId=1&panelId=51"

/** This middle part of URL refers to the piechart dashboard in grafana for recovered in Germany. */

const URL_MID_TOTAL_GERMANY_RECOVERED = "/d-solo/aim5ADoGz/total-germany-counties-states?orgId=1&panelId=49"

/** TThis middle part of URL refers to the piechart dashboard in grafana for deaths in Germany. */

const URL_MID_TOTAL_GERMANY_DEATHS = "/d-solo/aim5ADoGz/total-germany-counties-states?orgId=1&panelId=53"
...
interface PiechartcardStateProps {
    stateId: number
    panelTheme?: string | null
    panelHeight?: string
}

export function PiechartcardState(props: PiechartcardStateProps) {
            ...
            <div className={classes.root}>
                ...
                <TabPanel value={value} index={3}>
                    <Typography color="textSecondary" component="p" variant="h5">
                        - Infektionen: Gesamtzahlen der Infektionen im Verhältnis zueinander <br />
                        - Genesene: Gesamtzahlen der Genesenen im Verhältnis zueinander<br />
                        - Todesfälle: Gesamtzahlen der Todesfälle im Verhältnis zueinander<br />
                        Die hier gezeigten Zahlen sind relativ zu 100.000 Einwohnern.<br />
                        <br />
                        Durch Anklicken des Namen eines Eintrags in der Legende rechts neben des Diagramms mit der linken Maustaste lässt sich der jeweilige Eintrag im Kreisdiagramm aus- und einblenden.<br />
...
export default PiechartcardState;