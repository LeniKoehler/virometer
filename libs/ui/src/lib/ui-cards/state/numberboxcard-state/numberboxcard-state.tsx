...
const URL_MID_NUMBERBOX = "/d-solo/jzvjta0Gz/numberbox-per-state?orgId=1&panelId="
...
interface NumberboxcardStateProps {
  stateId: number
  panelTheme?: string | null
}

export const NumberboxcardState = (props: NumberboxcardStateProps) => {
  ...
  useEffect(() => {
    ...
    if (stateId < 1) {
      ...
      setUrl(`${URL_BASE}${URL_MID_NUMBERBOX}${stateId}${panelTheme}`)
    }
  }, [panelTheme, stateId])
...
export default NumberboxcardState;