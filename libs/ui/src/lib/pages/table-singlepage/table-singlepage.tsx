 ...
 * pages. This page contains the UI-Cards for the two tables for total Germany.
 * 
...
export interface TableSinglePageProps {
    match: {
        params: {
            countyId: string
        }
...
export const TableSinglePage = (props: TableSinglePageProps) => {
...
export default TableSinglePage;
